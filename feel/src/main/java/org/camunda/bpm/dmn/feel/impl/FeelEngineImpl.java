...
public class FeelEngineImpl implements FeelEngine {
  ...
  public <T> T evaluateSimpleUnaryTests(String simpleUnaryTests, String inputName, Map<String, Object> variables) {
  ...
  public <T> T evaluateSimpleUnaryTests(String simpleUnaryTests, String inputName, VariableMap variables) {
    try {
