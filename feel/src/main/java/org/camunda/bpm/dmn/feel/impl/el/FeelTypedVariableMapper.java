...
public class FeelTypedVariableMapper extends VariableMapper {
  ...
  public Object unpackVariable(String variable) {
    ...
    if (valueTyped instanceof LocalDateValue) {
      return new ComparableLocalDateValue((LocalDateValue) valueTyped);
    } else if (valueTyped instanceof LocalTimeValue) {
      return new ComparableLocalTimeValue((LocalTimeValue) valueTyped);
    }
    else {
