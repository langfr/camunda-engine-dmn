...
public class FeelEngineTest {
  ...
  public void testLong() {
    ...
    variables.putValue("x", new LocalDate());
  ...
  public <T> T evaluateFeel(Object input, String feelExpression) {
  ...
  protected DateValue parseDateTime(String dateTimeString) {
    return Variables.dateValue(new DateTime(dateTimeString).toDate());
  }
