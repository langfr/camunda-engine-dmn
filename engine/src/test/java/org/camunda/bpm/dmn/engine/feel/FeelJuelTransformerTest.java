...
import org.camunda.bpm.dmn.engine.impl.feel.FeelInputEntryHandler;
...
public class FeelJuelTransformerTest extends FeelTheJuelTest {
  ...
  class FeelJuelEngineConfiguration extends DmnEngineConfigurationImpl {
    ...
    protected void initElementHandlerRegistry() {
      ...
      elementHandlerRegistry.getElementHandlers().put(InputEntry.class, new FeelInputEntryHandler());
