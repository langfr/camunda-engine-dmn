...
public class FeelJuelTransformerEvaluateTest {
  ...
  public SimpleContext createElContext() {
    try {
      Method parseDate = getClass().getMethod("parseDate", String.class);
  ...
  class TestElContext extends SimpleContext {
  ...
  class TestFunctionMapper extends FunctionMapper {
